...
import {useAddImageMutation, useGetOrderByIdQuery, useGetPrintFormatsQuery} from "../services/ordersApi";
...
const ImageRedactor = () => {
    ...
    const handleCreateOrder = async () => {
        try {
            ...
            await addImage({ orderId, formData }).unwrap();
            ...
            alert(`Ошибка при создании заказа: ${err.message || err.data?.error}`);
        }
    };
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h3 style={{color: '#fff', marginTop: 0, textAlign: 'center'}}>Добавление фотографии</h3>
                ...
                <div style={{
                    ...
                    <h4 style={{color: '#fff', marginTop: 0}}>Формат печати</h4>
                    <div style={{
                        display: 'grid',
                        ...
                        {formats.map(format => (
                            <button
                                ...
                                style={{
                                    padding: '8px',
                                    backgroundColor: printFormat === format.name ? '#1a73e8' : '#3a3a3a',
                                    color: '#fff',
                                    border: 'none',
                                    borderRadius: '4px',
                                    cursor: 'pointer',
                ...
                <div style={{
                    ...
                    <h4 style={{color: '#fff', marginTop: 0}}>Загрузка фотографии</h4>
                    <label style={{
            ...
            {selectedFile.name}
                ...
                {previewUrl && (
                    <div style={{
                        ...
                        <h4 style={{color: '#fff', marginTop: 0}}>Выберите область печати</h4>
                        ...
                        <div style={{
                            ...
                            <h4 style={{color: '#fff', marginTop: 0}}>Настройки изображения</h4>
                ...
                <div style={{textAlign: 'center', marginTop: '20px'}}>
                    <button
                        ...
                        style={{
                            padding: '12px 30px',
                            backgroundColor: creating ? '#555' : '#1a73e8',
                            color: '#fff',
                            border: 'none',
                            borderRadius: '4px',
                    ...
                    <button
                        ...
                        onMouseOver={(e) => (e.currentTarget.style.backgroundColor = 'rgba(26,115,232,0.1)')}
