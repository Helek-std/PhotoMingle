...
from .views import OrderListView, OrderCreateView, OrderDetailView, OrderDeleteImageView, OrderCompleteView, \
    ...
    OrderInviteView, OrderAddImage

urlpatterns = [
    path("orders/", OrderListView.as_view(), name="orders-list"),
    path("orders/create/", OrderCreateView.as_view(), name="orders-create"),
    path("orders/<uuid:order_id>/", OrderDetailView.as_view(), name="order-detail"),
    path("orders/<uuid:order_id>/deleteImage/", OrderDeleteImageView.as_view(), name="order-delete-image"),
    ...
    path('orders/<uuid:order_id>/addImage/', OrderAddImage.as_view(), name='order-detail'),
